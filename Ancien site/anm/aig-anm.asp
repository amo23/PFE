...
psql="SELECT xlaAIGimages.*, xlaAIGcategories.catname,xlaAIGcategories.catpath,xlaAIGcategories.catpath + xlaAIGimages.imagefile as imagepath FROM xlaAIGcategories INNER JOIN xlaAIGimages ON xlaAIGcategories.categoryid = xlaAIGimages.categoryid where (imagename like '%"&stext&"%' or imagedesc like '%"&stext&"%' or imagefile like '%"&stext&"%') and (catname like '%"&catname&"%') "
